...
def criar_bd_tabelas():
  ...
  cursor.execute("CREATE TABLE IF NOT EXISTS administradores( id_administrador int(11) NOT NULL AUTO_INCREMENT, nome varchar(255) NOT NULL, senha varchar(255) NOT NULL, email varchar(255) NOT NULL UNIQUE, criado datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id_administrador))")
  cursor.execute("CREATE TABLE IF NOT EXISTS usuarios (id_usuario int(11) NOT NULL AUTO_INCREMENT,nome varchar(255) NOT NULL,senha varchar(255) NOT NULL,email varchar(255) NOT NULL UNIQUE,criado datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id_usuario),CONSTRAINT UC_usuario UNIQUE (email))")
  cursor.execute("CREATE TABLE IF NOT EXISTS grupos (id_grupo int(11) NOT NULL AUTO_INCREMENT,nome varchar(255) NOT NULL,criado datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id_grupo))")
  ...
  cursor.execute("CREATE TABLE IF NOT EXISTS banidos(id_banidos int(11) NOT NULL AUTO_INCREMENT,id_administrador int(11) NOT NULL,id_usuario int(11) NOT NULL,criado datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id_banidos),CONSTRAINT banidos_fk_1 FOREIGN KEY (id_usuario)REFERENCES usuarios (id_usuario) ON DELETE CASCADE,CONSTRAINT banidos_fk_2 FOREIGN KEY (id_administrador)REFERENCES administradores (id_administrador) ON DELETE CASCADE)")
